...
[![filesize](https://flat.badgen.net/badgesize/gzip/file-url/unpkg.com/blurhash-sw@1.0.6/dist/index.js)](https://unpkg.com/blurhash-sw@1.0.6/dist/index.js)
...
```js
// sw.js
importScripts('https://unpkg.com/blurhash-sw@1.0.6/dist/index.js');
